	...
	$.fn.iqDropdown = function (options) {
		this.each(function () {
			...
			const dataAttrOptions = {
				...
				buttons: $selection.data('buttons'), isClearBtn: $selection.data('isClearBtn'),
				isApplyBtn: $selection.data('isApplyBtn'),
				clearBtnContent: $selection.data('clearBtnContent'),
				applyBtnContent: $selection.data('applyBtnContent'),
			};
